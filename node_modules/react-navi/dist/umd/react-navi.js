(function (global, factory) {
    ...
    var Link = Object.assign(React.forwardRef(function (props, anchorRef) {
        ...
        var actualActive = useActive(href, { exact: !!exact });
        if (active === undefined) {
            active = actualActive;
        }
    ...
    function useView(_a) {
        ...
        var childContext = React.useMemo(function () { return (__assign$2({}, context, { unconsumedSteadyRouteChunks: final
                ? []
    ...
    var View = function View(_a) {
        var children = _a.children, disableScrolling = _a.disableScrolling, hashScrollBehavior = _a.hashScrollBehavior, renderHead = _a.renderHead, where = _a.where;
        var context = React.useContext(NaviContext);
        var result = useView({
        ...
        React.useEffect(function () {
            {
                if (children) {
                    console.warn("Deprecation Warning: Passing a render prop for \"<View>\" children is deprecated. From Navi 0.14, " +
        ...
        if (children) {
            ...
            if (typeof children !== 'function') {
                throw new Error("A Navi <View> expects any children to be a function, but instead received \"" + children + "\".");
            }
            return result.connect(React.createElement(React.Fragment, null,
                result.head,
    ...
    function NaviConsumer(_a) {
        ...
        React.useEffect(function () {
            {
                console.warn("Deprecation Warning: \"<NaviConsumer>\" is deprecated. From Navi 0.14, " +
    ...
    function LoadingRoute(props) {
        React.useEffect(function () {
            {
                console.warn("Deprecation Warning: \"<LoadingRoute>\" is deprecated. From Navi 0.14, " +
    ...
    function CurrentRoute(props) {
        React.useEffect(function () {
            {
                console.warn("Deprecation Warning: \"<CurrentRoute>\" is deprecated. From Navi 0.14, " +
