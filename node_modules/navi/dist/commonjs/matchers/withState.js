        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [5 /*yield**/, __values(Resolvable_1.default(stateMaybeResolvable, request, function (mergeState) {
                        var state = mergeState === null ? request.state : __assign({}, request.state, mergeState);
                        return Matcher_1.concatMatcherIterators(chunks(mergeState === null ? [] : [Chunks_1.createChunk('state', request, { state: state })]), Matcher_1.createMatcherIterator(child, __assign({}, request, { state: state })));
                    }))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
